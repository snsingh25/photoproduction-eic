...
//              in thick and thick jet samples across different eta ranges
//
...
void purity_plots_thick() {
    ...
    */
    ...
    // Set graph styles for thick jets
    g_thick_QQ->SetLineColor(color_QQ);
    g_thick_QQ->SetMarkerColor(color_QQ);
    g_thick_QQ->SetLineWidth(4);
    g_thick_QQ->SetMarkerStyle(20);
    g_thick_QQ->SetMarkerSize(1.4);
    
    g_thick_GG->SetLineColor(color_GG);
    g_thick_GG->SetMarkerColor(color_GG);
    g_thick_GG->SetLineWidth(4);
    g_thick_GG->SetMarkerStyle(21);
    g_thick_GG->SetMarkerSize(1.4);
    
    g_thick_GQ->SetLineColor(color_GQ);
    g_thick_GQ->SetMarkerColor(color_GQ);
    g_thick_GQ->SetLineWidth(4);
    g_thick_GQ->SetMarkerStyle(22);
    g_thick_GQ->SetMarkerSize(1.4);
    ...
    legend->SetHeader("Thick Jets");
    legend->AddEntry(g_thick_QQ, "QQ", "lp");
    legend->AddEntry(g_thick_GG, "GG", "lp");
    legend->AddEntry(g_thick_GQ, "GQ", "lp");
    
    legend->Draw();
    
    c1->SaveAs("purity_analysis_thick_jets.pdf");
    ...
    cout << "\nPlots saved as: purity_analysis_thick_jets.pdf" << endl;
